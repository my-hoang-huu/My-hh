...
FROM KETQUATHI A
WHERE MAMH = 'CSDL' AND LANTHI IN (
SELECT MAX(LANTHI) [LANTHICUOI]
FROM KETQUATHI B
...
SELECT TOP 1 WITH TIES K.MAMH, TENMH, COUNT(K.MAHV) SOHOCVIEN
FROM MONHOC M, KETQUATHI1 K
WHERE M.MAMH= K.MAMH AND KQUA ='KHONG DAT' AND LANTHI = 1
GROUP BY K.MAMH, TENMH
ORDER BY COUNT(K.MAHV) DESC
